...
reprogrammer.eval()
os.makedirs("reprogram_viz_stl10_bkground_bkdoor", exist_ok=True)
...
for i in range(10):
    ...
    vutils.save_image(img, f"reprogram_viz_stl10_bkground_bkdoor/img_{i}_true_{true_label}_pred_{pred_label}.png")

print("✅ 已儲存 10 張 reprogrammed 圖像至資料夾：reprogram_viz_stl10_bkground_bkdoor/")
...
plt.savefig("reprogram_viz_stl10_bkground_bkdoor/reprogrammed_bkground_grid.png")
plt.close()

# ====== 儲存學到的組件 ======
bg = reprogrammer.bg.detach().cpu().squeeze(0).clamp(0, 1)
vutils.save_image(bg, "reprogram_viz_stl10_bkground_bkdoor/learned_background.png")
...
plt.tight_layout()
plt.savefig("reprogram_viz_stl10_bkground_bkdoor/label_mapping_matrix.png")
plt.close()

print("✅ 已儲存學到的背景圖：reprogram_viz_stl10_bkground_bkdoor/learned_background.png")
print("✅ 已儲存標籤映射矩陣：reprogram_viz_stl10_bkground_bkdoor/label_mapping_matrix.png")
