...
for i in range(10):
    ...
    vutils.save_image(img, f"reprogram_viz_bkground/img_{i}_true_{true_label}_pred_{pred_label}.png")
...
plt.tight_layout()
plt.savefig("reprogram_viz_bkground/label_mapping_matrix.png")
plt.close()

print("✅ 已儲存學到的背景圖：reprogram_viz_bkground/learned_background.png")
print("✅ 已儲存標籤映射矩陣：reprogram_viz_bkground/label_mapping_matrix.png")
...
}, 'checkpoints/reprogram_model_with_mapping.pth')
